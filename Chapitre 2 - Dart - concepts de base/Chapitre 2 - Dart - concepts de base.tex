...
\begin{frame}[fragile,t]{\secname : \subsecname}
    ...
    \end{itemize}
    \lstinputlisting[language=java]{../exemples/Chapitre 2 - Dart - concepts de base/chapitre-2-dart-concepts-de-base/bin/var.dart}
\end{frame}
...
\begin{frame}[fragile,t]{\secname : \subsecname}
    ...
    \end{itemize}
    \lstinputlisting[language=java]{../exemples/Chapitre 2 - Dart - concepts de base/chapitre-2-dart-concepts-de-base/bin/const.dart}
\end{frame}
